const abiBones = [
	{
		inputs: [
			...
			{ internalType: "address[]", name: "_interfaces", type: "address[]" },
			{ internalType: "string", name: "_provenance", type: "string" },
			{
				components: [
					{ internalType: "uint16", name: "maxSupply", type: "uint16" },
					{ internalType: "bool", name: "pubPerWallet", type: "bool" },
					...
					{ internalType: "bool", name: "refer2earn", type: "bool" },
			...
			},
			{
				components: [
					...
					{ internalType: "uint24", name: "basisPoints", type: "uint24" },
				],
				internalType: "struct ERC721AContract.RoyaltyInfo",
				name: "_royalties",
				type: "tuple",
			},
		],
	...
	},
	{
		...
		name: "mintpass",
		outputs: [
			{ internalType: "contract IMintPass", name: "", type: "address" },
		],
		stateMutability: "view",
		type: "function",
	},
	...
	},
	{
		inputs: [
			...
			{ internalType: "bool", name: "_pubPerWallet", type: "bool" },
		],
		name: "updateConfig",
		outputs: [],
		stateMutability: "nonpayable",
	...
	},
	{
		inputs: [
			...
			{ internalType: "bool", name: "_refer2earn", type: "bool" },
		],
